...
<table style="word-break: keep-all;">
 ...
 <tr>
  ...
  <td>
   <p><strong>Covered by the Invoke-Obfuscation author himself, even for the method commented out in the code:</strong></p>
...
<table style="word-break: keep-all;">
 ...
 <tr>
  ...
  <td>
   <p><strong>Partialy covered by the same Sigma rules mentioned in task 10, that's because the source code block is copy/pasted into almost every encoding function so they can maintain zero dependencies and work on their own. These are examples of some not covered obfuscations:</strong></p>
