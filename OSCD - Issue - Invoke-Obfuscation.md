...
<table style="word-break: keep-all;">
 ...
 <tr>
  ...
  <td>
   <p><strong>Options LAUNCHER\VAR+\0 - LAUNCHER\VAR+\8 of this launcher just apply different <br>PS keys the same way as <a href="https://github.com/zinint/oscd_Invoke-Obfuscation/blob/master/OSCD%20-%20Issue%20-%20Invoke-Obfuscation.md#ps-launcher-obfuscation"> LAUNCHER\PS\* (case 10)</a>, so in this case we should <br>only hunt for VAR+ indicators:</strong></p>
